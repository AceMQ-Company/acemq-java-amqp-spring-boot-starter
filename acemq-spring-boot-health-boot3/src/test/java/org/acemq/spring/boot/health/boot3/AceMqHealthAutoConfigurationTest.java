...
/** The Boot 3 health indicator, against a real connection over the in-memory transport. */
class AceMqHealthAutoConfigurationTest {
    ...
    private final ApplicationContextRunner runner = new ApplicationContextRunner()
            ...
            .withPropertyValues("acemq.url=memory://health-boot3-" + BROKERS.incrementAndGet());
    ...
    void backsOffWhenTheApplicationDefinesItsOwn() {
        runner.withBean("aceMqHealthIndicator", AceMqHealthIndicator.class,
                        () -> new AceMqHealthIndicator(AceMq.connect("memory://health-boot3-own")))
